...
| `04-criterios-de-analisis.md` | El catálogo de criterios con su procedimiento de verificación | ✅ |
| `05-matriz-de-veredictos.md` | Cada criterio × 3 plataformas | 🔄 generado |
