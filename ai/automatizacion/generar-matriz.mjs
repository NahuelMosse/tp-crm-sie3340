...
const CRITERIOS = [
  ...
  ['A.6', 'Ficha única del asegurado', [
    ...
    ['A.6.2', 'Vista única del asegurado', 'nucleo'],
  ...
  ['A.7', 'Intercambio de datos y correo', [
    ...
    ['A.7.6', 'Exportación de la cartera sin pérdida de datos', 'soporte'],
  ]],
  ...
  ['A.11', 'Condiciones técnicas del producto', [
    ...
    ['A.11.9', 'Ecosistema de integraciones disponible', 'soporte'],
